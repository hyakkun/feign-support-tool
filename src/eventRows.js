...
const eventRows = [
  { type: EVENT_TYPE.EXILE, label: "追放", editor: "player-then-optional-dead-role", deathVisual: "default" },
  { type: EVENT_TYPE.KILL, label: "殺害", editor: "player-then-optional-dead-role", deathVisual: "default" },
  ...
  { type: EVENT_TYPE.SELF_DESTRUCT, label: "自爆", editor: "player-then-optional-dead-role", deathVisual: "magic-misfire" },
  { type: EVENT_TYPE.CHAIN_DEATH, label: "道連れ", editor: "player-then-optional-dead-role", deathVisual: "default" },
];
...
export const isSelfDestructLabel = (label) => label === "自爆";
